...
│
└── workflows/                          # 跨平台业务流程
    ├── jupiter_to_bybit.py             # Jupiter → Bybit 套利条件计算（无亏损条件检查、滑点上限）
    └── bybit_to_jupiter.py             # Bybit → Jupiter 套利条件计算（无亏损条件检查、滑点上限）
```
...
│
└── workflow/                           # 业务流程测试
    ├── test_jupiter_to_bybit_calc.py   # 测试 Jupiter → Bybit 套利条件计算
    └── test_bybit_to_jupiter_calc.py   # 测试 Bybit → Jupiter 套利条件计算
```
